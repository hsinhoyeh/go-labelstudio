...
/*
StorageLocalApiService Create export storage
...
func (a *StorageLocalApiService) ApiStoragesExportLocalfilesCreate(ctx context.Context, data LocalFilesExportStorage) (LocalFilesExportStorage, *http.Response, error) {
	var (
		...
		localVarReturnValue LocalFilesExportStorage
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/storages/export/localfiles"
...
/*
StorageLocalApiService Delete export storage
...
func (a *StorageLocalApiService) ApiStoragesExportLocalfilesDelete(ctx context.Context, id int32) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/storages/export/localfiles/{id}"
...
/*
StorageLocalApiService Get all export storage
Get a list of all Local export storage connections.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *StorageLocalApiApiStoragesExportLocalfilesListOpts - Optional Parameters:
...
func (a *StorageLocalApiService) ApiStoragesExportLocalfilesList(ctx context.Context, localVarOptionals *StorageLocalApiApiStoragesExportLocalfilesListOpts) ([]LocalFilesExportStorage, *http.Response, error) {
	var (
...
/*
StorageLocalApiService Update export storage
...
/*
StorageLocalApiService Get export storage
...
/*
StorageLocalApiService Sync export storage
...
func (a *StorageLocalApiService) ApiStoragesExportLocalfilesSyncCreate(ctx context.Context, id string, data LocalFilesExportStorage) (LocalFilesExportStorage, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/storages/export/localfiles/{id}/sync"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
StorageLocalApiService Validate export storage
...
func (a *StorageLocalApiService) ApiStoragesExportLocalfilesValidateCreate(ctx context.Context, data LocalFilesExportStorage) (LocalFilesExportStorage, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/storages/export/localfiles/validate"
...
/*
StorageLocalApiService Create import storage
...
*/
func (a *StorageLocalApiService) ApiStoragesLocalfilesCreate(ctx context.Context, data LocalFilesImportStorage) (LocalFilesImportStorage, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue LocalFilesImportStorage
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/storages/localfiles/"
...
/*
StorageLocalApiService Delete import storage
...
func (a *StorageLocalApiService) ApiStoragesLocalfilesDelete(ctx context.Context, id int32) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/storages/localfiles/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
StorageLocalApiService Get all import storage
Get a list of all local file import storage connections.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *StorageLocalApiApiStoragesLocalfilesListOpts - Optional Parameters:
     * @param "Project" (optional.Int32) -  Project ID
...
func (a *StorageLocalApiService) ApiStoragesLocalfilesList(ctx context.Context, localVarOptionals *StorageLocalApiApiStoragesLocalfilesListOpts) ([]LocalFilesImportStorage, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
StorageLocalApiService Update import storage
...
/*
StorageLocalApiService Get import storage
...
/*
StorageLocalApiService Sync import storage
...
func (a *StorageLocalApiService) ApiStoragesLocalfilesSyncCreate(ctx context.Context, id string, data LocalFilesImportStorage) (LocalFilesImportStorage, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/storages/localfiles/{id}/sync"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
StorageLocalApiService Validate import storage
...
func (a *StorageLocalApiService) ApiStoragesLocalfilesValidateCreate(ctx context.Context, data LocalFilesImportStorage) (LocalFilesImportStorage, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/storages/localfiles/validate"
